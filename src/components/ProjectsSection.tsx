...
import learnsphereImg from "@/assets/learnsphereImg.PNG"; // ✅ exact filename

const projects = [
  {
    title: "Proposal Perfect",
    description:
      "AI-powered freelance proposal generator that crafts personalized, high-converting proposals for Upwork, Fiverr, and LinkedIn in seconds.",
  ...
  },
  {
    title: "Baig Brothers",
    description:
      "Premium rice e-commerce website showcasing product varieties, company history, gallery, and contact — trusted across continents since 1985.",
  ...
  },
  {
    ...
    description:
      "AI tools directory platform to discover, compare, and explore 500+ curated AI tools across writing, coding, image generation, and more.",
  ...
  },
  {
    ...
    description:
      "Personalized learning recommendation system using AI to suggest courses based on user preferences and progress, helping learners achieve goals faster.",
    ...
    <section id="projects" className="py-24 relative">
      <div className="container mx-auto px-6" ref={ref}>
        <motion.div
          ...
          animate={isInView ? { opacity: 1, y: 0 } : { opacity: 1, y: 0 }} // fallback so always renders
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, i) => (
            <motion.a
              ...
              animate={isInView ? { opacity: 1, y: 0 } : { opacity: 1, y: 0 }} // ensures LearnSphere AI shows
